...
if __name__ == '__main__':
    ...
    destination_file = "/Users/georgioschristopoulos/Desktop/audio_files/audio9.csv"

    # If no language arguments, use 'mandarin' as default
    try:
        #languages = ['slovak']
                    #['hijazi' ,'norwegian','afrikaans' ,'hindi ','hindi-urdu','akan','albanian' ,'amharic' ,'hungarian' ,'igbo' ,'panjabi']#,
                    #[ 'arabic', 'pashto' ,'patois' ,'armenian' ,'indonesian' ,'persian', 'azerbaijani' ,'italian' ,'jamaican%20creole','english']
                    #['polish ','japanese ','portuguese' ,'bahasa' ,'indonesia' ,'punjabi' ,'romanian','russian' ,'kannada']
                    #['khalkha' ,'mongol', 'khmer', 'bengali', 'serbian' ,'bosnian' ,'bulgarian' ,'cantonese','kiswahili' ,'catalan' ,'sinhala']
                     #[ 'korean' ,'sinhalese' ,'slovak' ,'somali', 'chinese' ,'kurdish' ,'spanish' ,'swahili' ,'swedish ','swiss%20german']
                    #['croatian', 'czech' ,'danish' ,'lithuanian' ,'dari' ,'tagalog' ,'taiwanese' ,'tajiki' ,'dutch', 'tamil' ,'english' ,'estonian']
                   # 'farsi' ,'finnish' ,'flemish', 'macedonian','malay' ,'malayalam' ,'mandarin' ,'telugu' ,'thai' ,'tigrigna','turkish']
                    #'ukrainian', 'rdu' ,'vietnamese', 'marathi', 'french' ,'georgian', 'german' ,'greek','gujarati', 'miskito' ,'mongolian']
                     languages = ['najdi', 'wu', 'yiddish' ,'yoruba', 'nepali' ,'hausa' ,'hebrew']#sys.argv[2:]
    except:
        languages = ['mandarin']
        pass
